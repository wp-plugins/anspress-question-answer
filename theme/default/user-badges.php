		...
		if($user_badges):
			foreach($user_badges as $b){
				echo '<li><ul class="ap-badge-item clearfix">';
					...
					echo '<li class="ap-badge-type"><i class="ap-apicon-badge badge-'.$badge['type'].'"></i><span>'.$badge['type'].'</span></li>';
					...
					echo '<li class="ap-badge-date ap-apicon-clock">'.ap_human_time($b->date, false).'</li>';
				echo '</ul></li>';
			}
		else:
