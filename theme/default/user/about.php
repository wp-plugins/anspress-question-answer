			...
			<ul class="ap-about-stats clearfix">
				<li>
					<div class="ap-about-stats-item">
						<?php echo ap_icon('answer', true); ?><?php printf(__('%d answers, %d selected', 'ap'), ap_user_get_the_meta('__total_answers'), ap_user_get_the_meta('__best_answers')); ?>
					</div>
				</li>
				<li>
					<div class="ap-about-stats-item">
						<?php echo ap_icon('question', true); ?><?php printf(__('%d questions, %d solved', 'ap'), ap_user_get_the_meta('__total_questions'), ap_user_get_the_meta('__solved_answers')); ?>
					</div>
				</li>
				<li>
					<div class="ap-about-stats-item">
						<?php echo ap_icon('clock', true); ?><?php printf(__('Member for %s', 'ap'), ap_user_get_member_for()); ?>
					</div>
				</li>
				<li>
					<div class="ap-about-stats-item">
						<?php echo ap_icon('eye', true); ?><?php printf(__('%d profile views', 'ap'), ap_user_get_the_meta('__profile_views')); ?>
					</div>
				</li>
				<li>
					<div class="ap-about-stats-item">
